<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page.Master" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="Stock_Market_Project.WebForm2" EnableEventValidation="false" ValidateRequest="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolder3" runat="server">
    ...
    <asp:Button ID="Button1" runat="server" Text="Button" OnClick="AS" />
</asp:Content>
